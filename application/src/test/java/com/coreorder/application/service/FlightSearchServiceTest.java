...
class FlightSearchServiceTest {
    ...
    @BeforeEach
    void setUp() {
        travelportProvider = new FakeFlightSearchProvider("TRAVELPORT");
        amadeusProvider = new FakeFlightSearchProvider("AMADEUS");
    ...
    void shouldFallbackToFirstAvailableWhenNoPreference() {
        ...
        // Should pick the first available (TRAVELPORT)
    ...
    private static class FakeFlightSearchProvider implements FlightSearchProvider {
        ...
        FakeFlightSearchProvider(String id) {
            this.id = id;
        }
