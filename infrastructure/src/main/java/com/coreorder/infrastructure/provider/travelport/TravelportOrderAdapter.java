 ...
 * <p>
 * In production, this would call Travelport's Air Create Reservation API.
 */
public class TravelportOrderAdapter implements OrderManagementProvider {
    ...
    public Order createOrder(OrderCreateRequest request) {
        try {
            // In production: call Travelport's Air Create Reservation API
            // For now: construct a mock order
    ...
    public Order retrieveOrder(String providerOrderId) {
        try {
            // In production: call Travelport's Air Retrieve Reservation API
    ...
    public Order cancelOrder(String providerOrderId) {
        try {
            // In production: call Travelport's Air Cancel Reservation API
