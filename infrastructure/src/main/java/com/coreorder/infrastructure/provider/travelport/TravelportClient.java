 ...
 * <p>
 * In production, this would make real HTTP calls to Travelport's REST/SOAP endpoints.
 * This implementation returns realistic mock data for development and testing.
 */
public class TravelportClient {
    ...
    public List<TravelportFlightResponse> searchFlights(FlightSearchCriteria criteria) {
        // In production: real HTTP call to Travelport LowFareSearch endpoint
        // For now: return realistic mock data based on the criteria
